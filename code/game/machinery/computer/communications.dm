...
/obj/machinery/computer/communications
	...
	desc = "Это позволяет капитану связаться с Центральным Командованием или изменить уровень тревоги. Это также позволяет командному составу вызвать аварийный шаттл."
